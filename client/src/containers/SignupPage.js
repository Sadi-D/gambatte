      ...
      <React.Fragment>
        ...
        <main className={classes.layout}>
          <Paper className={classes.paper}>
            <Typography variant="headline">GAMBATTE</Typography>
            {successfulSignup && (
              <NavLink to="/login" className={classes.successText}>
                Inscription reussie, cliquez-ici pour vous connecter !
              </NavLink>
            )}
            <form onSubmit={this.handleSubmit} noValidate>
              ...
              <FormControl margin="normal" required fullWidth>
                <InputLabel htmlFor="password">Confirmez le mot de passe</InputLabel>
                <Input
                  onChange={this.handleInputChange}
